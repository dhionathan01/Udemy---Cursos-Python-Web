...
AcessarDados.escolher_arquivo('funcionario')
...
AcessarDisco.salva(funcionario2, 'funcionario')
arquivo = AcessarDados.Leitura()
print(arquivo)
...
AcessarDados.escolher_arquivo('departamento')
arquivo = AcessarDados.Leitura()
print(arquivo)
...
AcessarDados.escolher_arquivo('gerente')
arquivo = AcessarDados.Leitura()
print(arquivo)
print(type(arquivo))
