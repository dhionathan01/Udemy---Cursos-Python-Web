...
OBS: A partir do python3+ a função reduce() não é uma função integrada (built-in).
...
A função reduce() funciona da seguinte forma:
    Passo 1: resultado1 = f(a1, a2) # Aplica a função nos dois primeiros elementos da coleção e guarda o resultado.
    Passo 2: resultado2 = f(res1, a3) # Aplica a função passando o resultado do passo 1 mais o terceiro elemento e
    guarda o resultado.
    Isso é repetido até o final.
    Passo 3: ressultado3 = f(res2, a4)
    .
    .
    .
    Passo n: resn = f(resm, an)

Ou seja, em cada passo ela aplica a função passando como primeiro argumento o resultado da aplicação anterior. No fina,
